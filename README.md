...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/svg-animator-utility.git
   cd svg-animator-utility
   ```
...
[![Repo](https://img.shields.io/badge/svg-animator-utility-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/svg-animator-utility)
